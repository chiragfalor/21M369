...
class Piano extends SoundObject {
    constructor(pitch = 60, duration=0.75) {
        super();
    ...
    setup_sound() {
      ...
      play_sound() {
        this.player.queueWaveTable(this.audioContext, this.audioContext.destination, this.selectedPreset,0 ,this.pitch-12, this.duration, 1);
    }
...
class Snare extends SoundObject {
    ...
    setup_sound() {
      ...
      play_sound() {
        ...
        this.player.queueWaveTable(this.audioContext, this.audioContext.destination, _drum_40_1_JCLive_sf2_file, 0, 40, 3, 0.4);
    }
